package com.sistema.dobby.controller;

import com.sistema.dobby.administration.model.Usuario;
import com.sistema.dobby.administracion.services.RolServiceImp;
...
//        }
        ...
        if(usuarioService.tienePermiso(operacion + VIEW)) {
            ...
            if(usuarioService.tienePermiso(P_ASIGNAR_ROL)) {
                usuario.getRoles().add(rolService.existeRol(objetoDTO.getIdRol().longValue()));
            } else {
                usuario.getRoles().add(rolService.existeRol(1L)); // ID 1: Rol sin permisos.
            }
